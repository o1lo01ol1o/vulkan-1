...
pattern COMPOSITION_LAYER_CORRECT_CHROMATIC_ABERRATION_BIT = CompositionLayerFlagBits 0x00000001
-- No documentation found for Nested "XrCompositionLayerFlagBits" "XR_COMPOSITION_LAYER_BLEND_TEXTURE_SOURCE_ALPHA_BIT"
pattern COMPOSITION_LAYER_BLEND_TEXTURE_SOURCE_ALPHA_BIT   = CompositionLayerFlagBits 0x00000002
-- No documentation found for Nested "XrCompositionLayerFlagBits" "XR_COMPOSITION_LAYER_UNPREMULTIPLIED_ALPHA_BIT"
pattern COMPOSITION_LAYER_UNPREMULTIPLIED_ALPHA_BIT        = CompositionLayerFlagBits 0x00000004
