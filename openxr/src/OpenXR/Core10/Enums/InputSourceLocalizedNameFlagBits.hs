...
pattern INPUT_SOURCE_LOCALIZED_NAME_USER_PATH_BIT           = InputSourceLocalizedNameFlagBits 0x00000001
...
pattern INPUT_SOURCE_LOCALIZED_NAME_INTERACTION_PROFILE_BIT = InputSourceLocalizedNameFlagBits 0x00000002
-- No documentation found for Nested "XrInputSourceLocalizedNameFlagBits" "XR_INPUT_SOURCE_LOCALIZED_NAME_COMPONENT_BIT"
pattern INPUT_SOURCE_LOCALIZED_NAME_COMPONENT_BIT           = InputSourceLocalizedNameFlagBits 0x00000004
