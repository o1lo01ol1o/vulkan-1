...
pattern SWAPCHAIN_CREATE_PROTECTED_CONTENT_BIT = SwapchainCreateFlagBits 0x00000001
-- No documentation found for Nested "XrSwapchainCreateFlagBits" "XR_SWAPCHAIN_CREATE_STATIC_IMAGE_BIT"
pattern SWAPCHAIN_CREATE_STATIC_IMAGE_BIT      = SwapchainCreateFlagBits 0x00000002
