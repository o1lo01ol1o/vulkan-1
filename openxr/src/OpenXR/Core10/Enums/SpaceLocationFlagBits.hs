...
pattern SPACE_LOCATION_ORIENTATION_VALID_BIT   = SpaceLocationFlagBits 0x00000001
-- No documentation found for Nested "XrSpaceLocationFlagBits" "XR_SPACE_LOCATION_POSITION_VALID_BIT"
pattern SPACE_LOCATION_POSITION_VALID_BIT      = SpaceLocationFlagBits 0x00000002
-- No documentation found for Nested "XrSpaceLocationFlagBits" "XR_SPACE_LOCATION_ORIENTATION_TRACKED_BIT"
pattern SPACE_LOCATION_ORIENTATION_TRACKED_BIT = SpaceLocationFlagBits 0x00000004
-- No documentation found for Nested "XrSpaceLocationFlagBits" "XR_SPACE_LOCATION_POSITION_TRACKED_BIT"
pattern SPACE_LOCATION_POSITION_TRACKED_BIT    = SpaceLocationFlagBits 0x00000008
